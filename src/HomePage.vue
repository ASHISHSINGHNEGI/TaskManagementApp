<template>
    <div class="task">
        ...
        <TaskList :tasks="userTasks" @completeTask="completeTask" @editTask="editTask" @deleteTask="deleteTask" />
    </div>
</template>
...
const deleteTask = (taskId: number) => {
    ...
    tasks.value = updatedTasks.filter(
        (task: Task) => task.userId === currentUser
    );
